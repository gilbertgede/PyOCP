...
Bool Double_Integrator__2_eval_f(Index n, Number* x, Bool new_x, Number* obj_value,
                            UserDataPtr user_data);

Bool Double_Integrator__2_eval_grad_f(Index n, Number* x, Bool new_x,
                                 Number* grad_f, UserDataPtr user_data);

Bool Double_Integrator__2_eval_g(Index n, Number* x, Bool new_x, Index m, Number* g,
                            UserDataPtr user_data);

Bool Double_Integrator__2_eval_jac_g(Index n, Number *x, Bool new_x, Index m,
